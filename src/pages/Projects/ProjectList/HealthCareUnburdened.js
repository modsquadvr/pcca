  ...
  return (
    <Container>
      <Grid container spacing={4} rowSpacing={{xs:3, lg:10}} justifyContent="center" alignItems="flex-start">
        ...
        <Grid item xs={12} component="img" src={harvesting} className="card-image"/>
        ...
        <Grid item xs={12} md={4} component="img" src={lecture} className="card-image"/>
        <Grid item xs={12} md={4} component="img" src={derekAndy} className="card-image"/>
        <Grid item xs={12} md={4} component="img" src={aldynView} className="card-image"/>
        ...
        <Grid item xs={12} component="img" src={group} className="card-image"/>
      </Grid>
    </Container>
  );
}